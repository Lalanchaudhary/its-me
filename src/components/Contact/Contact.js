        ...
        <div className="contact flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 mt-10 text-white">
          <div className="contact-text text-center md:w-1/2">
            ...
            <div className="contact-icons flex justify-center gap-4 mt-6">
              <a href="https://m.facebook.com/Lalan.bharal?ref=bookmarks" className="text-blue-500"><i className="bx bxl-facebook-circle text-4xl"></i></a>
              <a href="https://www.instagram.com/its_me_Lalan18/" className="text-pink-500"><i className="bx bxl-instagram text-4xl"></i></a>
              <a href="www.linkedin.com/in/Lalan-bharal-5a2a49238" className="text-blue-700"><i className="bx bxl-linkedin text-4xl"></i></a>
